  ...
  data(){
    return{
      Traditionaldata:[
        ...
        {content:"Have time to allow showings and don’t mind having strangers in your home"},
...
.page4 .item13 div:last-child p:first-child{
  font-size: 36px;
  font-width: 600;
}
.page4 .item13 div:last-child p:last-child{
