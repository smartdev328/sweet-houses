          ...
          <div class="space-40"></div>
            ...
            <div class="item1a">
                <p class="font-weight-bold" v-if="listingsold">{{listingsold.count.toLocaleString('ja-JP')}}
                  <span class="DMSerifRegular text-color-2" style="font-size: 16px;" v-if="listingsold.count > 15000">Listings Found | Showing {{reshowing}} <br>Only 1500 properties may be displayed per search. To see all your results, try narrowing your search criteria</span>
